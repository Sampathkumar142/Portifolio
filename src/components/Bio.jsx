...
export default function Bio() {
  return (
    <section className='ph:grid ph:grid-cols-2 w-full ph:h-[80vh] my-2 ph:gap-4 overflow-auto flex flex-col-reverse'>
        <div className=' flex flex-col ph:justify-end ph:m-4 justify-start  m-3 '>
        ...
        <div className='flex justify-center items-center' >
          <img  className='ph:h-[70vh] ph:w-[80%] h-[30vh] rounded-full ph:rounded-xl object-cover' src={bioimg} alt="" />
        </div>
    </section>
  )
}
